...
public class e implements Callback {
    ...
    public e(Callback callback, TextView textView) {
        this.f4992a = callback;
        this.f4993b = textView;
    }

    public boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
        return this.f4992a.onActionItemClicked(actionMode, menuItem);
    }

    public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
        return this.f4992a.onCreateActionMode(actionMode, menu);
    }

    public void onDestroyActionMode(ActionMode actionMode) {
        this.f4992a.onDestroyActionMode(actionMode);
    }
    ...
    public boolean onPrepareActionMode(android.view.ActionMode r13, android.view.Menu r14) {
        /*
            r12 = this;
            android.widget.TextView r0 = r12.f4993b
            android.content.Context r0 = r0.getContext()
            android.content.pm.PackageManager r1 = r0.getPackageManager()
            boolean r2 = r12.f4997f
            ...
            r12.f4994c = r2     // Catch:{ ClassNotFoundException | NoSuchMethodException -> 0x002b }
            ...
            r12.f4995d = r2     // Catch:{ ClassNotFoundException | NoSuchMethodException -> 0x002b }
            r12.f4996e = r5     // Catch:{ ClassNotFoundException | NoSuchMethodException -> 0x002b }
            goto L_0x0032
        L_0x002b:
            r2 = 0
            r12.f4994c = r2
            ...
            r12.f4996e = r4
        L_0x0032:
            boolean r2 = r12.f4996e     // Catch:{ IllegalAccessException | NoSuchMethodException | InvocationTargetException -> 0x0129 }
            if (r2 == 0) goto L_0x0041
            java.lang.Class r2 = r12.f4994c     // Catch:{ IllegalAccessException | NoSuchMethodException | InvocationTargetException -> 0x0129 }
            boolean r2 = r2.isInstance(r14)     // Catch:{ IllegalAccessException | NoSuchMethodException | InvocationTargetException -> 0x0129 }
            if (r2 == 0) goto L_0x0041
            java.lang.reflect.Method r2 = r12.f4995d     // Catch:{ IllegalAccessException | NoSuchMethodException | InvocationTargetException -> 0x0129 }
            goto L_0x004f
        L_0x0041:
        ...
        L_0x00d6:
            ...
            android.widget.TextView r9 = r12.f4993b
        ...
        L_0x010e:
            ...
            goto L_0x00d6
        L_0x0129:
            android.view.ActionMode$Callback r0 = r12.f4992a
            boolean r13 = r0.onPrepareActionMode(r13, r14)
            return r13
        */
        throw new UnsupportedOperationException("Method not decompiled: d.h.l.e.onPrepareActionMode(android.view.ActionMode, android.view.Menu):boolean");
    }
}
