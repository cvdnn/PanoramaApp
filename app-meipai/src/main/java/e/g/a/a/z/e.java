...
public class e extends i0 {
    ...
    public e(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.t = true;
        this.u = false;
        TypedArray b2 = h.b(context, attributeSet, k.ForegroundLinearLayout, i2, 0, new int[0]);
        this.s = b2.getInt(k.ForegroundLinearLayout_android_foregroundGravity, this.s);
        Drawable drawable = b2.getDrawable(k.ForegroundLinearLayout_android_foreground);
        if (drawable != null) {
            setForeground(drawable);
        }
        this.t = b2.getBoolean(k.ForegroundLinearLayout_foregroundInsidePadding, true);
        b2.recycle();
    }
}
