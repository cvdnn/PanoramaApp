...
/* compiled from: ActivitySpinCaptureBindingImpl */
public class o extends n implements OnExtClickListener {
    public static final SparseIntArray S;
    public final ConstraintLayout L;
    public final OnClickListener M;
    public final OnClickListener N;
    public final OnClickListener tv4ClickListener;
    ...
    static {
        ...
        S.put(R.id.fl_take, 18);
        S.put(R.id.task_progress, 19);
        S.put(R.id.task_progress_current, 20);
        S.put(R.id.task_progress_total, 21);
    }

    public o(d dVar, View view) {
        Object[] a2 = ViewDataBinding.a(dVar, view, 22, (c) null, S);
        super(dVar, view, 0, (Button) a2[2], (FrameLayout) a2[11], (LottieAnimationView) a2[16], (DiscreteScrollView) a2[5], (FrameLayout) a2[18], (TextView) a2[15], (ConstraintLayout) a2[14], (LottieAnimationView) a2[12], (GuideView) a2[1], (RelativeLayout) a2[17], (View) a2[13], (TextView) a2[7], (CircleProgressBar) a2[19], (TextView) a2[20], (LinearLayout) a2[8], (TextView) a2[21], (Button) a2[4], (ImageView) a2[9], (Switch) a2[10], (ImageView) a2[6], (ImageView) a2[3]);
        this.n.setTag(null);
        this.q.setTag(null);
        this.v.setTag(null);
        ...
        this.M = new e.c.d.h.a.a(this, 3);
        this.N = new e.c.d.h.a.a(this, 1);
        this.tv4ClickListener = new e.c.d.h.a.a(this, 4);
        this.P = new e.c.d.h.a.a(this, 2);
        this.Q = new e.c.d.h.a.a(this, 5);
        f();
    }
    ...
    public final void onExtClick(int i2, View view) {
        ...
        if (i2 == 1) {
            ...
            if (z) {
                spinCaptureActivity2.userGuide();
            }
        } else if (i2 == 3) {
    ...
    public void b() {
        ...
        if ((8 & j2) != 0) {
            ...
            this.tv4.setOnClickListener(this.tv4ClickListener);
