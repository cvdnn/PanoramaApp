...
public class ay {
    ...
    public static final ay f1677b = new ay();

    /* renamed from: a reason: collision with root package name */
    public HashMap<String, String> f1678a = new HashMap<>();
    ...
    private void a(String str, String str2) {
        if (!TextUtils.isEmpty(str) && !this.f1678a.containsKey(str)) {
            this.f1678a.put(str, str2.toUpperCase(Locale.ENGLISH));
        }
    }

    public String a(String str) {
        return (String) this.f1678a.get(str);
    }
}
