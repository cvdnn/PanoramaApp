...
public class Config {
    ...
    public static final String EXCEPT_FILE_NAME = a.a(new StringBuilder(), RES_PREFIX, "except_cache.json");
    ...
    public static final String LAST_AP_INFO_FILE_NAME = a.a(new StringBuilder(), RES_PREFIX, "ap_info_cache.json");
    public static final String LAST_SESSION_FILE_NAME = a.a(new StringBuilder(), RES_PREFIX, "last_session.json");
    ...
    public static final String STAT_CACHE_FILE_NAME = a.a(new StringBuilder(), RES_PREFIX, "stat_cache.json");
    public static final String STAT_FULL_CACHE_FILE_NAME = a.a(new StringBuilder(), RES_PREFIX, "stat_full_cache.json");
    ...
    public static final String STAT_SDK_VERSION_NUM = "3.9.7.1";
    ...
    public enum EventViewType {
        ...
        public String toString() {
            return String.valueOf(this.f1383a);
        }
    }
