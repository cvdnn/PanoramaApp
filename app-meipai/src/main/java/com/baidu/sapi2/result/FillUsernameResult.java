...
public class FillUsernameResult extends SapiResult {
    ...
    public FillUsernameResult() {
        SparseArray<String> sparseArray = this.msgMap;
        ...
        String str2 = "该用户名已被注册,请更换其他用户名";
        this.msgMap.put(RESULT_CODE_USERNAME_UNAVAILABLE, str2);
        this.msgMap.put(RESULT_CODE_USERNAME_FORMAT_INVALID, RESULT_MSG_USERNAME_FORMAT_INVALID);
        this.msgMap.put(RESULT_CODE_USERNAME_ALREADY_EXIST, str2);
