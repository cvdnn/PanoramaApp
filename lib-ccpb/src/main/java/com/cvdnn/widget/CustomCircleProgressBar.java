...
public class CustomCircleProgressBar extends View {
    ...
    public CustomCircleProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        outsideRadius = a.getDimension(R.styleable.CustomCircleProgressBar_outside_radius, Dimens.dp2px(getContext(), 60.0f));
        ...
        progressTextSize = a.getDimension(R.styleable.CustomCircleProgressBar_progress_text_size, Dimens.dp2px(getContext(), 14.0f));
        progressWidth = a.getDimension(R.styleable.CustomCircleProgressBar_progress_width, Dimens.dp2px(getContext(), 10.0f));
    ...
    public void setTextFlag(boolean flag) {
        mTextFlag = flag;
    }
    ...
    private String getProgressText() {
        return mTextFlag ? (int) progress + "/" + maxProgress : (int) ((progress / maxProgress) * 100) + "%";
    }
